        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div className="animate-slide-up">
            ...
            <div className="prose prose-stone text-lg text-stone-600 leading-relaxed">
              <p className="mb-6">
                Mazerolle Builders Ltd. is a family-run contracting company owned and operated by <strong>Roger and Shane Mazerolle</strong>, a father-and-son team originally from New Brunswick.
              </p>
              <p className="mb-6">
                <strong>Roger</strong> is a carpenter with over 30 years of experience, having worked across Saskatchewan, Alberta, and Ontario. He also holds certification as a building inspector in Alberta, bringing deep knowledge of codes, safety, and construction standards to every single job.
              </p>
              <p className="mb-6">
                <strong>Shane</strong> trained under his father for over a decade and now manages day-to-day site operations, ensuring every project is run efficiently, professionally, and with obsessive attention to detail.
              </p>
              <p>
                Together, they built Mazerolle Builders on the simple but powerful belief that quality work comes from personal accountability, hands-on involvement, and treating every project like it’s their own home.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-scale-in">
             <div className="space-y-4">
                <div className="rounded-sm shadow-lg w-full h-64 bg-stone-200 border-2 border-dashed border-stone-400 flex items-center justify-center">
                  <span className="text-stone-500 text-lg font-medium">Image here</span>
                </div>
                <div className="bg-brand-50 p-6 rounded-sm border-l-4 border-brand-700 shadow-md">
                   <h3 className="font-serif font-bold text-xl text-stone-800 mb-1">Roger Mazerolle</h3>
                   <p className="text-xs text-brand-700 font-bold uppercase tracking-wide">Co-Owner & Founder</p>
                   <p className="text-stone-600 mt-2 text-sm">30+ Years Exp. Building Inspector Certified.</p>
                </div>
             </div>
             <div className="space-y-4 pt-12 sm:pt-20">
                <div className="bg-stone-100 p-6 rounded-sm border-l-4 border-stone-400 shadow-md">
                   <h3 className="font-serif font-bold text-xl text-stone-800 mb-1">Shane Mazerolle</h3>
                   <p className="text-xs text-brand-700 font-bold uppercase tracking-wide">Co-Owner & Site Manager</p>
                   <p className="text-stone-600 mt-2 text-sm">Operations Lead. Precision & Efficiency.</p>
                </div>
                <div className="rounded-sm shadow-lg w-full h-64 bg-stone-200 border-2 border-dashed border-stone-400 flex items-center justify-center">
                  <span className="text-stone-500 text-lg font-medium">Image here</span>
                </div>
